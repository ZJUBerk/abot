...
class LocalPlanner:
    def __init__(self):
        ...
        self.plan_config.robot_type = RobotType.circle
        c = self.plan_config
        ...
        self.path_sub = rospy.Subscriber('/abot/global_path',Path,self.pathCallback)
        self.vel_pub = rospy.Publisher('/cmd_vel',Twist, queue_size=1)
        self.midpose_pub = rospy.Publisher('/abot/mid_goal',PoseStamped,queue_size=1)
